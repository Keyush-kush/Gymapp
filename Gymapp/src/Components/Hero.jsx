...
function Hero() {
  return (
    ...
    <h1 className='uppercase text-4xl font-semibold sm:text-5xl md:text-6xl lg:text-7xl'>work<span className='text-blue-400 font-medium glow-on-hover'>extreme</span></h1>
    </div>
    <p className='text-lg sm:text-xl md:text-2xl lg:text-3xl'>Lorem ipsum dolor sit amet consectetur, 
        ...
        <button 
  className='px-8 py-3 bg-gray-800 text-white  uppercase font-semibold rounded-lg blueShadow  duration-300  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'
>
  <p>Accept & Begin</p>
</button>
  </div>
